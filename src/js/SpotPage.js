...
export default function SpotPage() {
    ...
    const record = location.state.content.Record;
    const filterInfo = location.state.filterInfo;
    const manage = location.state?.manage;
    ...
    useEffect(() => {
        ...
        if (endDate === null && filterInfo != null) {
        ...
        // const lat = record.LatLong.split("_")[0];
        // const lng = record.LatLong.split("_")[1];
    ...
    function handleSubmission() {
        ...
        if (isValidSubmission()) {
            ...
            console.log(myData);
            fetch('http://localhost:3000/testAPI/reserve', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            console.log("there was a problem with your purchase")
        }
        //This stuff should be dependent on a SUCCESSFUL response
    ...
    return (
        <div className="container">
            <div className="title">
                <Typography variant="h4">{record.Address}</Typography>
            ...
            <div className="body">
                <div>
                    <Typography variant="h6">
                        Spot hosted by {record.HostID}
                    </Typography>
                    <Typography variant="subtitle1" color="text.secondary">
                        type: {record.Type}     |     current status: {availability}
                    </Typography>
                </div>
                <div>
                        ...
                        <div className="checkoutContainer">
                            <div className="checkoutHeader">
                                <Typography variant="h6" gutterBottom
                                    sx={{ fontWeight: "bold", fontSize: 24 }}>${record.Price}</Typography>
